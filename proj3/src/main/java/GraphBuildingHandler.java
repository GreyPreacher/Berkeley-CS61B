...
public class GraphBuildingHandler extends DefaultHandler {
    ...
    private GraphDB.Vertex curVertex;
    private GraphDB.Edge curEdge;
    private boolean highway =false;
    private List<Long> vertices = null;
    private List<Long> edges = null;
    private String last;
    private long edgeID;
    ...
    public void startElement(String uri, String localName, String qName, Attributes attributes)
        ...
        if (qName.equals("node")) {
            ...
            curVertex = new GraphDB.Vertex(Long.parseLong(attributes.getValue("id")),
            ...
            curEdge = new GraphDB.Edge(edgeID, vertices);
            anotherWayID = edgeID;
            ...
            vertices.add(Long.parseLong(attributes.getValue("ref")));
    ...
    public void endElement(String uri, String localName, String qName) throws SAXException {
        if (qName.equals("way")) {
            ...
            if (highway) {
                Long[] arr = vertices.toArray(new Long[vertices.size()]);
                for (int i = 0; i < arr.length - 1; ++i) {
                    if (!g.vertex.get(arr[i]).adjs.contains(arr[i + 1])) {
                ...
                for (int i = 0; i < arr.length; ++i) {
                    if (wayName.equals("")) break;
                    g.vertex.get(arr[i]).setName(wayName);
                }
                GraphDB.Edge e = new GraphDB.Edge(edgeID, vertices);
                e.setName(wayName);
                wayName = "";
                g.addEdge(e);
                highway = false;
